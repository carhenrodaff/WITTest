define(["questAPI"], function (Quest) {
  ...
  API.addQuestionsSet("attributes7", {
    ...
    answers: [
      {
        text: "I strongly prefer <%= global.whiteLabels %> to <%= global.blackLabels %>.",
        value: 7,
      },
      {
        text: "I moderately prefer <%= global.whiteLabels %> to <%= global.blackLabels %>.",
        value: 6,
      },
      {
        text: "I slightly prefer <%= global.whiteLabels %> to <%= global.blackLabels %>.",
        value: 5,
      },
      {
        text: "I like <%= global.whiteLabels %> and <%= global.blackLabels %> equally.",
        value: 4,
      },
      {
        text: "I slightly prefer <%= global.blackLabels %> to <%= global.whiteLabels %>.",
        value: 3,
      },
      {
        text: "I moderately prefer <%= global.blackLabels %> to <%= global.whiteLabels %>.",
        value: 2,
      },
      {
        text: "I strongly prefer <%= global.blackLabels %> to <%= global.whiteLabels %>.",
        value: 1,
      },
    ],
  });
